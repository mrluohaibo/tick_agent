...
def get_version_string() -> str:
    """
    get the version of my_akshare
    :return: version number
    :rtype: str, e.g. '0.6.24'
    """
    with open("my_akshare/__init__.py", "rb") as _f:
...
setuptools.setup(
    ...
    extras_require={
        # 这些是额外的依赖集合，可以通过 'pip install my_akshare[full]' 安装
        "full": [
            "akqmt",
        ],
        # 这些是额外的依赖集合，可以通过 'pip install my_akshare[qmt]' 安装
        "qmt": [
            "akqmt",
        ],
    },
