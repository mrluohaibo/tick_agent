...
from bz_agent.agents.llm import vl_llm
...
expected_browser = Browser(
    config=BrowserConfig(
        # chrome_instance_path=CHROME_INSTANCE_PATH, # 使用内置浏览器
        headless = False,
    )
)
...
if __name__ == "__main__":
    instruction = "Open https://www.baidu.com and search for '监利天气', then read the first result."
